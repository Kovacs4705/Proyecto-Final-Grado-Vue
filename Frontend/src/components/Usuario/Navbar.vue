    ...
    <nav ref="nav" :class="['navbar', 'navbar-expand-lg', 'navbar-dark', 'navbar-custom', { scrolled }]">
        <div class="container-fluid d-flex align-items-center px-4">
            ...
            <div class="wrapper" :class="{ open: menuOpen }">
                <ul>
                    <li><router-link to="/usuario" @click="menuOpen = false">Inicio</router-link></li>
                    <li><router-link to="/usuario/biblioteca" @click="menuOpen = false">Biblioteca</router-link></li>
                    <li><router-link to="/usuario/explorar" @click="menuOpen = false">Explorar</router-link></li>
                    <li><router-link to="/usuario/noticias" @click="menuOpen = false">Noticias</router-link></li>
                </ul>
            </div>
